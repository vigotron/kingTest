...
public class AppiumSetup {
    ...
    public void init() {
        ...
        File apkWallapop = new File("/home/vigo/Documents/king_test/kingTest/src/main/java/Utils/Apps/wallapop-1-95-1.apk");

        DesiredCapabilities caps = new DesiredCapabilities();
        caps.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, 30);
        caps.setCapability(MobileCapabilityType.APP, apkWallapop.getAbsolutePath());
